...
\newcommand{\ipaMaxEcoAbiertas}{50,6}
...
\newcommand{\ipaGlobalInterpretation}{\begin{itemize}
    ...
    \vspace{0.2cm}
    \item Comparativa \textbf{2023T3 vs 2026Q1}: Crecimiento absoluto de \textbf{+3,6 puntos} en la etapa reciente.
    \vspace{0.2cm}
...
\newcommand{\ipaEconomiasInterpretation}{\begin{itemize}
    ...
    \vspace{0.1cm}
    \item \textbf{Resultado actual (2026Q1)}: Se alcanzan los \textbf{50,5 puntos} (el máximo de la serie histórica se sitúa en \textbf{50,6 puntos}).
\end{itemize}}
